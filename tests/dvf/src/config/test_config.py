...
from dvf.src.config.config_loader import Config

class TestConfig(unittest.TestCase):

    def test_valid_config(self):
        path = Path("tests/dvf/src/config/test_files/test_config_1.yaml")
    ...
    def test_not_yaml_file(self):
        path = Path("tests/dvf/src/config/test_files/test_config_2.json")
